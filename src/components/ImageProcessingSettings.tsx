...
import { Settings, Crop, Zap, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        >
          <h2 className="text-xl font-bold text-slate-800">Fine-tune Optimization</h2>
          {isExpanded ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"
                />
